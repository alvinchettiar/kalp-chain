...
|
*/
//$config['base_url'] = 'http://localhost:85/kalp/';
$config['base_url'] = 'http://localhost.kalp';
...
|
*/
$config['encryption_key'] = 'asdadadasdasd';
...
/* Adding AutoLoad function for custom core classes */
